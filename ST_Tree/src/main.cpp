...
int main(int argc, char *argv[])
{
    if (argc != 5)
    {
        printf("Invalid usage of program. Need to provide four extra command line arguments. e.g ./ST_Tree.out 2 1 0 1\n\
...
Fourth number represents whether to use sample graph or no, 0 - no sample graph, 1 - work on sample graph");
        return 0;
    }
